...
function ScreenWithoutScrolling(props: ScreenProps) {
  ...
  return (
    <View className="flex-1 h-100 w-100" style={[style]}>
...
function ScreenWithScrolling(props: ScreenProps) {
  ...
  return (
    <ScrollView
      ...
      className="bg-background flex-1 h-100 w-100"
...
export function Screen(props: ScreenProps) {
  ...
  return (
    <View className="bg-background flex-1 h-100 w-100" style={$containerInsets}>
